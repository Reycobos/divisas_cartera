...
# 🚨 CLAVES ACTUALES (parecen ser para HMAC, no RSA)
...
# =============================================================================
# INICIALIZACIÓN DEL CLIENTE SDK CORREGIDA - USANDO HMAC
# =============================================================================
...
if not API_KEY or not SECRET_KEY:
    ...
    print(f"[LBANK DIAG] 🔐 Usando HMAC-SHA256 (clave parece formato HMAC)")

    try:
        # ✅ CORRECCIÓN DEFINITIVA: Usar HmacSHA256 con formato correcto
        LBANK_CLIENT = BlockHttpClient(
            sign_method="HmacSHA256",  # ← USAR HMAC con tu clave actual
            api_key=API_KEY,
            api_secret=SECRET_KEY,
            base_url=BASE_URL, 
            log_level=logging.INFO 
        )
        print("[LBANK SDK] ✅ Cliente SDK inicializado correctamente con HmacSHA256")
...
def _fetch_trades_for_symbol(symbol: str, start_date: str = None, end_date: str = None,
    ...
    """
    Obtiene trades de un símbolo específico usando el SDK.
