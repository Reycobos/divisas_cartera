...
class HyperliquidFIFO:
    ...
    # =========================
    def reconstruct_closed_positions(self, days: int = 90):
        end_time = utc_now_ms()
...
def save_hyperliquid_closed_positions(db_path: str = "portfolio.db", days: int = 90, debug: bool = False) -> int:
...
def debug_hyperliquid_fifo_reconstruction(symbol: str = None, days: int = 90):
